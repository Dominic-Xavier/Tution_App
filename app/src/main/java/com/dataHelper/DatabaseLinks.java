...
public class DatabaseLinks {
    ...
    public static StorageReference storageReference = FirebaseStorage.getInstance("gs://tutor-project-1cc32.appspot.com").getReference();
    ...
    public static StorageReference getInstituteRef(String ins_id){
